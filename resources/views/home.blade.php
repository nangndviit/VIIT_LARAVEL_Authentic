...
<head>
    ...
    <title>LARAVEL - Authentic - Shoes</title>
    <meta name="title" content />

    <link rel="shortcut icon"
        href="https://png.pngtree.com/png-clipart/20220911/original/pngtree-letter-s-logo-vector-design-png-image_8545049.png"
        type="image/svg+xml" />
        ...
        <div class="container">
            ...
            <nav class="navbar" data-navbar>
                <ul class="navbar-list">
                    ...
                    <li class="navbar-item">
                        <a href="#" class="navbar-link" data-nav-link>GIÀY<i
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="https://cdn.authentic-shoes.com/wp-content/uploads/2024/01/Designer-Below-Retail-Apparel-an-2048x648.webp"
                                class="d-block w-100" alt="..." />
                        </div>
                        <div class="carousel-item">
                            <img src="https://cdn.authentic-shoes.com/wp-content/uploads/2024/01/BrandCampaign_LaunchBanners_Prim-1-2048x623.webp"
                                class="d-block w-100" alt="..." />
                        </div>
                        <div class="carousel-item">
                            <img src="https://cdn.authentic-shoes.com/wp-content/uploads/2024/01/AJ1_Yellow_Ochre_Release_DayPrim-2048x625.webp"
                                class="d-block w-100" alt="..." />
                        </div>
                    </div>
                    <div class="click">
        ...
        <div class="footer-top section" id>
            <div class="container">
                <div class="footer-brand">
                    ...
                    <img style="width: 100px; height: 20px; margin-left: 15px"
                        src="https://images.dmca.com/Badges/dmca-badge-w100-5x1-08.png?ID=9bda31ca-31ab-4a2d-b9df-8bced834801e"
                        alt />
                </div>
                ...
                <ul class="footer-list">
                    ...
                    <img style="margin-top: 10px; line-height: 26px"
                        src="https://cdn.authentic-shoes.com/wp-content/uploads/2023/04/thongbao.png" alt />
                </ul>
